...
public class panel_proveedor extends JPanel{
    ...
    protected JButton btnMail = new JButton("Editar");
    ...
    private String label[]={"RFC:","NOMBRE:","RAZON SOCIAL:","CALLE:","NUMERO:","COLONIA:","MUNICIPIO:","ENTIDAD:","CODIGO POSTAL:"};
    ...
    */
    ...
    /**
     * datos para combox
     * @param Telefonos- recibe una lista de los telefono de los proveedores
     * @param Correos- recibe una lista de los correo de los proveedores
     */
     ...
     */
    public void conectaControlador(controlador.controladorProveedor c  ){
        //botones
	...
	btnNuevo.setActionCommand("NUEVO");
        ////**************
        btnMail.addActionListener(c);
        btnMail.setActionCommand("UPMAIL");
		
	btnTele.addActionListener(c);
	btnTele.setActionCommand("UPTELE");
        //jcombox
        tele.addActionListener(c);
	tele.setActionCommand("TELEFONO");
